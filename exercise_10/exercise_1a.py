...
def parse_and_process(args):
    ...
    group.add_argument('--identity', action='store_const', const='identity', dest='preprocessing',
                    help='Do not change individual strings before concatenating.')
    group.add_argument('--sort', action='store_const', const='sort', dest='preprocessing',
